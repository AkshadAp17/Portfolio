      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 md:flex md:items-center md:justify-between">
          <div className="flex space-x-6 md:order-2">
            <img src="https://via.placeholder.com/40x24/ffffff/000000?text=VISA" alt="Visa" className="h-6" />
            <img src="https://via.placeholder.com/40x24/ffffff/000000?text=MC" alt="Mastercard" className="h-6" />
            <img src="https://via.placeholder.com/40x24/ffffff/000000?text=AMEX" alt="American Express" className="h-6" />
            <img src="https://via.placeholder.com/40x24/ffffff/000000?text=PP" alt="PayPal" className="h-6" />
          </div>
